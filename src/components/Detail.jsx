...
export default function Detail() {
    ...
    const getWhetherCorrect = useMemo(() => {
        return context.state.debtData
            ...
            userRecordsStatic.reduce((sum, item) => sum + item.shouldGet, 0)
            ? '帳目正確'
            : '帳目有誤'
    ...
    return (
        <div>
            <div className="text-start">
                ...
                <p className="fw-light m-0">在這裡將顯示所有欠款與還款詳情</p>
            </div>
                    ...
                    {userRecords.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <p
                                    className="text-muted small text-start user-select-none mb-0"
                                        ...
                                        return (
                                            <div className="d-flex align-items-center justify-content-center mb-4">
                                                ...
                                                >
                                                    <img
                                                        src={
                                                            getUserInfo(context.state.configData.users, itemBody.debtor)
                                                                .photo
                                                        }
                                                        style={{ height: '2rem' }}
                                                        alt="user"
                                                ...
                                                >
                                                    <p className="m-0 fw-bold fs-5">
                                                        ${numberWithCommas(itemBody.debt)}
                                                    </p>
                    ...
                    <nav>
                        <ul className="pagination">
                            <li className="page-item">
                                <button
                                    className="page-link"
                                    onClick={() => setPageNumber((prop) => Math.max(1, prop - 1))}
                                >
                                ...
                                if (pageNumber <= 2) {
                                    ...
                                    return (
                                        <li className="page-item">
                                            <button
                                                className="page-link"
                                                onClick={() => setPageNumber(totalPage - (i + 1))}
                                            >
                                                {totalPage - (i + 1)}
                                            </button>
                                        </li>
                                    ...
                                    return (
                                        <li className="page-item">
                                            <button
                                                className="page-link"
                                                onClick={() => setPageNumber(i - 2 + pageNumber)}
                                            >
                                                {i - 2 + pageNumber}
                                            </button>
                                        </li>
                            ...
                            <li className="page-item">
                                <button
                                    className="page-link"
                                    aria-label="Next"
                                    onClick={() => setPageNumber((prop) => prop + 1)}
                                >
