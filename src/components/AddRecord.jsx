...
import sendMessage from '../hooks/useSendMessage.js'
                ...
                >
                    ...
                    <div className="text-start mt-3">
                        <div className="d-flex align-items-center justify-content-between">
                            ...
                            <button
                                className={`btn btn-outline-${editMode ? 'secondary' : 'success'} btn-sm`}
                    ...
                    {newRecords.records.map((item, index) => (
                        <div key={item.id}>
                            <hr />
                                ...
                                {editMode ? (
                                    <div>
                                        <input
                                            ...
                                            className="form-control"
                                            placeholder="名稱"
                                            value={newRecords.records[index].remark}
                                            onChange={(e) => {
                                        ...
                                        <input
                                            ...
                                            placeholder="金額"
                                            value={newRecords.records[index].debt}
                                            onChange={(e) => {
                    ...
                    <div className="mt-3 mb-3">
                        <button
                            ...
                            onClick={async () => {
                                if (!newRecords.title || !newRecords.description || newRecords.records.length === 0)
