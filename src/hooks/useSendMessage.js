                            ...
                            contents: [
                                {
                                    ...
                                    contents: [
                                        {
                                            type: 'image',
                                            url: getUserInfo(context.state.configData.users, item.borrower).photo,
                                            size: '40px',
                                            aspectMode: 'fit',
                                        },
                                        {
                                            type: 'text',
                                            text: getUserInfo(context.state.configData.users, item.borrower).name,
                                            align: 'center',
                                            size: 'xxs',
                                            wrap: true,
                                        },
                                ...
                                },
                                {
                                    ...
                                    contents: [
                                        {
                                            type: 'image',
                                            url: getUserInfo(context.state.configData.users, item.debtor).photo,
                                            size: '40px',
                                            aspectMode: 'fit',
                                        },
                                        {
                                            type: 'text',
                                            text: getUserInfo(context.state.configData.users, item.debtor).name,
                                            align: 'center',
                                            size: 'xxs',
                                            wrap: true,
                                        },
                                ...
                                contents: [
                                    {
                                        ...
                                        contents: [
                                            {
                                                type: 'image',
                                                url: senderPhoto || `${APP_URL}/gray-icon.png`,
                                                size: '40px',
                                                aspectMode: 'fit',
                                            },
                                            {
                ...
                contents: [
                    {
                        ...
                        action: {
                            type: 'uri',
                            label: '更改',
                            uri: `https://liff.line.me/${LINE_LIFF}/?g=${context.userInfo.current.groupId}`,
                        },
                    },
                ],
            },
